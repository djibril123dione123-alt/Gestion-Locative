...
export function PremiumKpiGrid({
  ...
  if (variant === "dashboard") {
    if (itemCount === 4) {
      gridClasses = "grid-cols-2 sm:grid-cols-4 @xl:grid-cols-4";
    } else if (itemCount === 5) {
      gridClasses = "grid-cols-2 sm:grid-cols-5 @xl:grid-cols-5";
    } else if (itemCount === 3) {
      gridClasses = "grid-cols-1 sm:grid-cols-3 @md:grid-cols-3";
    } else if (itemCount === 2) {
      gridClasses = "grid-cols-2";
    } else if (itemCount === 1) {
      gridClasses = "grid-cols-1";
    } else {
      gridClasses = "grid-cols-2 sm:grid-cols-3 lg:grid-cols-6 @2xl:grid-cols-6";
    }
  } else {
    if (itemCount === 4) {
      gridClasses = "grid-cols-2 sm:grid-cols-4 @xl:grid-cols-4";

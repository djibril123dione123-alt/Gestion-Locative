  ...
  return (
    <PageShell spacing="compact" variant="dataDense" tone="paper" verticalInset="compact">
      ...
      <div className="space-y-2.5">
        ...
        <PremiumKpiGrid variant="dashboard" maxItems={detailPanelOpen ? 4 : 6} density="ultraCompact" ariaLabel="Indicateurs patrimoine">
          ...
          <MetricCard density="ultraCompact" label="Occupées" value={pageStats.occupied} helper="Baux en cours" icon={Home} tone="emerald" className="hidden sm:block" />
          ...
          <MetricCard density="ultraCompact" label="Loyers" value={<MoneyText value={pageStats.expectedRent} compact />} helper="Revenus attendus" icon={Wallet} tone="green" className={detailPanelOpen ? 'hidden 2xl:block' : ''} />
          <MetricCard density="ultraCompact" label="Reliquats" value={<MoneyText value={pageStats.reliquats} compact />} helper="Impayés en cours" icon={AlertCircle} tone="red" className={detailPanelOpen ? 'hidden 2xl:block' : 'hidden sm:block'} />
        </PremiumKpiGrid>
    ...
    >
      <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
        ...
        <div className={wizardStep === 'address' ? 'space-y-2.5 sm:space-y-2.5' : 'hidden'}>
          ...
          <Field label="Adresse *">
            <input required value={form.adresse} onChange={(event) => onChange((current) => ({ ...current, adresse: event.target.value }))} className="mt-0.5 h-9 w-full rounded-xl border border-emerald-950/10 bg-[#fffdf8]/90 px-3 text-[0.93rem] font-medium text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_1px_2px_rgba(0,0,0,0.012)] outline-none transition-all placeholder:font-normal placeholder:text-slate-400/80 focus:border-emerald-600/30 focus:bg-white focus:ring-2 focus:ring-emerald-600/10 autofill:bg-white autofill:shadow-[inset_0_0_0px_1000px_white] sm:!h-8 sm:!min-h-8 sm:rounded-[0.6rem] sm:text-[0.8rem]" placeholder="Rue, avenue, adresse principale" />
          </Field>
          <div className="grid gap-4 sm:grid-cols-2">
            <Field label="Quartier">
              <input value={form.quartier} onChange={(event) => onChange((current) => ({ ...current, quartier: event.target.value }))} className="mt-0.5 h-9 w-full rounded-xl border border-emerald-950/10 bg-[#fffdf8]/90 px-3 text-[0.93rem] font-medium text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_1px_2px_rgba(0,0,0,0.012)] outline-none transition-all placeholder:font-normal placeholder:text-slate-400/80 focus:border-emerald-600/30 focus:bg-white focus:ring-2 focus:ring-emerald-600/10 autofill:bg-white autofill:shadow-[inset_0_0_0px_1000px_white] sm:!h-8 sm:!min-h-8 sm:rounded-[0.6rem] sm:text-[0.8rem]" placeholder="Ouakam, Medina..." />
            </Field>
            <Field label="Ville *">
              <input required value={form.ville} onChange={(event) => onChange((current) => ({ ...current, ville: event.target.value }))} className="mt-0.5 h-9 w-full rounded-xl border border-emerald-950/10 bg-[#fffdf8]/90 px-3 text-[0.93rem] font-medium text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_1px_2px_rgba(0,0,0,0.012)] outline-none transition-all placeholder:font-normal placeholder:text-slate-400/80 focus:border-emerald-600/30 focus:bg-white focus:ring-2 focus:ring-emerald-600/10 autofill:bg-white autofill:shadow-[inset_0_0_0px_1000px_white] sm:!h-8 sm:!min-h-8 sm:rounded-[0.6rem] sm:text-[0.8rem]" placeholder="Dakar" />
            </Field>
          </div>
      ...
      <div className="space-y-2.5 sm:space-y-3 lg:space-y-4">
        <div className={wizardStep === 'main' ? 'space-y-2.5 sm:space-y-2.5' : 'hidden'}>
          ...
          <Field label="Numéro / code">
            <input value={form.numero} onChange={(event) => onChange((current) => ({ ...current, numero: event.target.value }))} className="mt-0.5 h-9 w-full rounded-xl border border-emerald-950/10 bg-[#fffdf8]/90 px-3 text-[0.93rem] font-medium text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_1px_2px_rgba(0,0,0,0.012)] outline-none transition-all placeholder:font-normal placeholder:text-slate-400/80 focus:border-emerald-600/30 focus:bg-white focus:ring-2 focus:ring-emerald-600/10 autofill:bg-white autofill:shadow-[inset_0_0_0px_1000px_white] sm:!h-8 sm:!min-h-8 sm:rounded-[0.6rem] sm:text-[0.8rem]" placeholder="A1, Boutique 3..." />
          </Field>
        </div>
        ...
        <div className="grid gap-4 sm:grid-cols-2">
          <Field label="Loyer mensuel *">
            <input required type="number" min="0" value={form.loyer_base} onChange={(event) => onChange((current) => ({ ...current, loyer_base: event.target.value }))} className="mt-0.5 h-9 w-full rounded-xl border border-emerald-950/10 bg-[#fffdf8]/90 px-3 text-[0.93rem] font-medium text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_1px_2px_rgba(0,0,0,0.012)] outline-none transition-all placeholder:font-normal placeholder:text-slate-400/80 focus:border-emerald-600/30 focus:bg-white focus:ring-2 focus:ring-emerald-600/10 autofill:bg-white autofill:shadow-[inset_0_0_0px_1000px_white] sm:!h-8 sm:!min-h-8 sm:rounded-[0.6rem] sm:text-[0.8rem]" placeholder="150000" />
          </Field>
          <Field label="Statut">
            <SmartCombobox density="compact"
              value={form.statut}
        ...
        <Field label="Étage (optionnel)">
          <input value={form.etage} onChange={(event) => onChange((current) => ({ ...current, etage: event.target.value }))} className="mt-0.5 h-9 w-full rounded-xl border border-emerald-950/10 bg-[#fffdf8]/90 px-3 text-[0.93rem] font-medium text-slate-900 shadow-[inset_0_1px_0_rgba(255,255,255,0.85),0_1px_2px_rgba(0,0,0,0.012)] outline-none transition-all placeholder:font-normal placeholder:text-slate-400/80 focus:border-emerald-600/30 focus:bg-white focus:ring-2 focus:ring-emerald-600/10 autofill:bg-white autofill:shadow-[inset_0_0_0px_1000px_white] sm:!h-8 sm:!min-h-8 sm:rounded-[0.6rem] sm:text-[0.8rem]" placeholder="RDC, 1er..." />
        </Field>
        <Field label="Description optionnelle">

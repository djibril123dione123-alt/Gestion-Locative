const SENSITIVE_KEY = /(?:authorization|cookie|password|secret|token|email|phone|telephone|address|adresse|cni|passport|piece|ninea|rccm|proof|preuve|document_url|signature|stamp)/i;

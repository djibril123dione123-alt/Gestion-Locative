...
- Name: auth.spec.ts >> Routes publiques et protégées >> une route métier protégée ne révèle pas son contenu sans session
...
Call log:
  - navigating to "http://localhost:5000/#/dashboard", waiting until "domcontentloaded"

    ...
    <PageShell spacing="compact" variant="dataDense" tone="paper" verticalInset="compact">
      ...
      <div className="space-y-2.5">
        ...
        <PremiumKpiGrid variant="dashboard" maxItems={6} density="ultraCompact" ariaLabel="Indicateurs patrimoine">
          ...
          <MetricCard density="ultraCompact" label="Reliquats" value={<MoneyText value={pageStats.reliquats} compact />} helper="Impayés en cours" icon={AlertCircle} tone="red" className="hidden sm:block" />
        </PremiumKpiGrid>

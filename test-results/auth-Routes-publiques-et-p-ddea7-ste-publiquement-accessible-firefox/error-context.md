...
- Name: auth.spec.ts >> Routes publiques et protégées >> la page tarifs reste publiquement accessible
...
Call log:
  - navigating to "http://localhost:5000/#/pricing", waiting until "domcontentloaded"

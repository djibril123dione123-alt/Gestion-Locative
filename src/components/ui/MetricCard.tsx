...
export function MetricCard({ label, value, icon: Icon, tone, wide = false, className = '' }: MetricCardProps) {
  ...
  return (
    <article
      className={`group min-w-0 rounded-[1.05rem] border border-emerald-950/10 bg-gradient-to-br ${tones.gradient} p-2.5 shadow-[0_9px_24px_rgba(15,23,42,0.045)] ring-1 ring-white/70 transition-all duration-200 hover:-translate-y-0.5 hover:border-emerald-200 hover:shadow-[0_13px_30px_rgba(15,23,42,0.075)] ${wide ? 'sm:col-span-2' : ''} ${className}`}
    >

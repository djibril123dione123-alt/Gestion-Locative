...
export const DEFAULT_AGENCY_SETTINGS: AgencySettingsFormInput = {
  ...
  mention_litige: "Il est expressément convenu qu'en cas de litige, les frais d'huissier, d'expertises et d'honoraires d'avocat engagés par le bailleur sur pièces justificatives seront remboursés par le locataire.",

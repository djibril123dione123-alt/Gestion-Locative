...
export const PERMISSION_CATALOG: PermissionCatalogItem[] = [
  { id: 'dashboard', label: 'Dashboard', description: 'Vue synthèse, KPIs et activité récente.', category: 'Pilotage' },
  { id: 'tableau-de-bord-financier', label: 'Analytics', description: 'Rapports financiers, métriques avancées et exports.', category: 'Pilotage', sensitive: true },
  { id: 'filtres-avances', label: 'Filtres avancés', description: 'Recherche approfondie et vues analytiques.', category: 'Pilotage', sensitive: true },
  { id: 'bailleurs', label: 'Bailleurs', description: 'Propriétaires, coordonnées et mandats.', category: 'Patrimoine' },
  { id: 'immeubles', label: 'Immeubles', description: 'Immeubles, adresses et regroupements.', category: 'Patrimoine' },
  { id: 'unites', label: 'Unités', description: 'Logements, loyers, disponibilités et états.', category: 'Patrimoine' },
  { id: 'locataires', label: 'Locataires', description: 'Fiches locataires, contacts et historique.', category: 'Locations' },
  { id: 'contrats', label: 'Contrats', description: 'Création, modification et suivi des baux.', category: 'Locations', sensitive: true },
  { id: 'paiements', label: 'Encaissements', description: 'Paiements reçus, reçus et actions financières.', category: 'Finance', sensitive: true },
  { id: 'loyers-impayes', label: 'Loyers impayés', description: 'Suivi des reliquats et relances.', category: 'Finance', sensitive: true },
  { id: 'depenses', label: 'Dépenses', description: 'Charges, dépenses et justificatifs.', category: 'Finance', sensitive: true },
  { id: 'commissions', label: 'Commissions', description: 'Ventilation agence/bailleur et commissions.', category: 'Finance', sensitive: true },
  { id: 'documents', label: 'Documents', description: 'Contrats, quittances, rapports et exports.', category: 'Documents' },
  { id: 'notifications', label: 'Notifications', description: 'Alertes, emails, SMS et centre de messages.', category: 'Documents' },
